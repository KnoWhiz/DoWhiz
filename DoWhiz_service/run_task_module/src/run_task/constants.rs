...
pub(super) const CODEX_MODEL_NAME: &str = "gpt-5.3-codex";
...
pub(super) const CODEX_CONFIG_BLOCK_TEMPLATE: &str = r#"# IMPORTANT: Use your Azure *deployment name* here (e.g., "gpt-5.3-codex")
model = "gpt-5.3-codex"
